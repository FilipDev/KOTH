...
public enum Message {
	...
	DEATH,
	STARTING,
	LEFT_QUEUE, RETURN_TO_QUEUE, GAME_STARTING_IN, JOINED_QUEUE, NEXT_ARENA_IN, FIRST_PLAYER_IN_HILL, LEFT_HILL, REWARD_INVENTORY_NAME, CHANGED_SPAWN_POINT, REWARD_EDIT_INVENTORY_NAME, REWARD_CLAIM_INVENTORY_NAME;
